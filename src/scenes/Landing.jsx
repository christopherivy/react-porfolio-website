    ...
    <section id="home" className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10">
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveMediumScreens ? (
          ...
          <img alt="profile" className="z-10 w-full max-w-[400px] md:max-w-[600px]" src="assets/profile-image.png" />
        )}
      </div>
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            ...
            <span
              ...
              before:absolute before:-left-[40px] before:-top-[140px] before:z-[-1]"
            >
              Ivy
            </span>
          </p>
